...
<template>
  <main class="min-h-screen bg-white text-gray-800">
    <!-- Hero -->
    <section class="flex justify-center relative isolate overflow-hidden bg-gradient-to-b from-rose-50 to-white">
    ...
    <!-- Venue -->
    <section class="flex justify-center mx-auto px-4 py-12 sm:py-16">
      <div class="max-w-5xl grid items-stretch gap-8 sm:grid-cols-2">
        <div class="flex flex-col sm:h-[420px]">
        ...
        <div class="overflow-hidden rounded-2xl ring-1 ring-gray-200 sm:h-[420px]">
          <img
